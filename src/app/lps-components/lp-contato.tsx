    ...
    return (
        <div className="sm:flex place-items-center justify-center mt-5 gap-8">
            <a href="tel:1934415051" className="flex border-2 p-3 border-black bg-white *:invert hover:invert">
                ...
                <p className="text-1xl sm:text-2xl pl-3 text-white">LIGUE AGORA <strong className="font-sariaBlack">{Utils.formatFone(data.info.areaCode, data.info.phone)}</strong></p>
            </a>
