  ...
  return (
    <div className="bg-ts-gray h-52 mys-0">
        ...
        <div className="justify-center mt-4 gap-5 --font-saira-bold font-thin text-2xl hidden lg:flex">
            <a href="#promos" className='hover:bg-black pl-4 pr-4 pt-2 pb-2 rounded-md'>OFERTAS</a>
            <a href="#about" className='hover:bg-black pl-4 pr-4 pt-2 pb-2 rounded-md'>QUEM SOMOS</a>
            <a href="#lojas" className='hover:bg-black pl-4 pr-4 pt-2 pb-2 rounded-md'>LOJAS</a>
        </div>
      ...
      {isVisible && (
        <div className='absolute right-3 z-10'>
          <div id="mobile-menu" className="flex-col bg-black rounded-lg space-y-2 mt-10 mr-6 flex right-0 text-center text-2xl w-44 p-2">
            <a href="#promos" className="text-white hover:bg-white/10 w-full rounded-sm">OFERTAS</a>
            <a href="#about" className="text-white hover:bg-white/10 w-full rounded-sm">QUEM SOMOS</a>
            <a href="#lojas" className="text-white hover:bg-white/10 w-full rounded-sm">LOJAS</a>
          </div>
        </div>)}
    </div>
  );
