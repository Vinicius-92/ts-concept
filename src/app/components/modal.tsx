...
const Modal: FC<ModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50" onClick={onClose}>
      ...
      <div className="bg-black p-6 rounded-lg shadow-lg max-w-md w-[400px] h-fit flex flex-col" onClick={(e) => e.stopPropagation()}>
		<button onClick={onClose} className='z-50 text-[1.5rem] ml-64'>
		  ...
		  <div className='flex flex-col justify-center mx-auto gap-5 pt-12'>
			...
			<a href="https://api.whatsapp.com/send/?phone=5508000177777&text=Ol%C3%A1%21%21%0A%0AVim+do+Site+da+TS+Pneus%2C+e+gostaria+de+saber+sobre+as+ofertas%21&type=phone_number&app_absent=0" target='_blank' className='mx-auto'>
				<img src="pocos.webp" alt="" />
			</a>
		  </div>
      </div>
    </div>
