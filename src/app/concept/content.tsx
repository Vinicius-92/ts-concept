...
export default function Content({ open, lockOverflow}: ContentProps) {
  return (
    <div className={`w-screen h-screen bg-black flex flex-col ${lockOverflow ? 'overflow-hidden' : ''}`}>
      <div className="bg-concept-gray w-screen h-56 flex justify-center items-center flex-col lg:flex-row">
        ...
        <div className="flex items-center mb-16 place-content-center gap-2 bg-[#191919] w-screen pt-2 pb-2 lg:bg-concept-gray lg:w-fit lg:mb-0">
          <a href="https://api.whatsapp.com/send/?phone=551921214067&text=Ol%C3%A1%21%21%0A%0AVim+do+Site+da+TS+Pneus%2C+e+gostaria+de+saber+sobre+as+ofertas%21&type=phone_number&app_absent=0" target='_blank'>
      ...
      <div className="h-[630px] w-screen bg-cover bg-no-repeat bg-center bg-tire-brands-bg flex flex-col content-center pt-3 pb-3">
        ...
        <a href="https://api.whatsapp.com/send/?phone=551921214067&text=Ol%C3%A1%21%21%0A%0AVim+do+Site+da+TS+Pneus%2C+e+gostaria+de+saber+sobre+as+ofertas%21&type=phone_number&app_absent=0" target='_blank' className='mx-auto'>
          <div className="custom-buttom text-[20px]">ENTRE EM CONTATO</div>
        </a>
        </div>
      </div>
